 ...
 */
package net.microservice.cloud.dashboard.config;

import net.microservice.cloud.dashboard.repository.ApplicationRepository;
import net.microservice.cloud.dashboard.repository.aws.BeanstalkRepository;
import net.microservice.cloud.dashboard.repository.eureka.LocaleEurekaRepository;
import net.microservice.cloud.dashboard.repository.eureka.RemoteEurekaRepository;
import net.microservice.cloud.dashboard.stream.CircuitBreakerStreamServlet;
...
@ComponentScan("net.microservice.cloud.dashboard")
